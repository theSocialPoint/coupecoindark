...
BITCOIND=${1}/coupecoindarkd
CLI=${1}/coupecoindark-cli
...
echo "Done, coupecoindarkd's shut down. To rerun/poke around:"
echo "${1}/coupecoindarkd -datadir=$D1 -daemon"
echo "${1}/coupecoindarkd -datadir=$D2 -daemon -connect=127.0.0.1:11000"
echo "To cleanup:"
echo "killall coupecoindarkd; rm -rf test.*"
exit 0
