TEMPLATE = app
TARGET = coupecoindark-qt
macx:TARGET = "Coupecoindark-Qt"
VERSION = 0.8.8.0
...
RESOURCES += src/qt/coupecoindark.qrc
...
# also add new translations to src/qt/coupecoindark.qrc under translations/
...
OTHER_FILES += README.md \
    ...
    doc/*.txt \
    doc/*.md \
    src/qt/res/coupecoindark-qt.rc \
    src/test/*.cpp \
    src/test/*.h \
    src/qt/test/*.cpp \
    src/qt/test/*.h
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/coupecoindark-qt.rc
...
macx:ICON = src/qt/res/icons/coupecoindark.icns
