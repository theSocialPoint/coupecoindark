...
unlocked to sign the Coupecoindark-Qt.app bundle.
...
allowing somebody to distribute a Coupecoindark-Qt.app or coupecoindark-qt-setup.exe with a valid
...
that the coupecoindark-qt.exe file inside the installer had not been tampered with.
