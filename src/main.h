...
enum DiffMode {
    DIFF_CLASSIC_CDARK	= 1, // Retarget every 720 blocks (Classic Coupecoindark style)
    DIFF_CDARK		= 2, // Retarget every 60 blocks (Coupecoindark style)
...
static const int64 DUST_SOFT_LIMIT = 75000; // 0.00075 CDARK
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 2500;   // 0.000025 CDARK mininput
...
public:
    ...
    */
    ...
    /** Amount of coupecoindarks spent by this transaction.
    ...
    /** Amount of coupecoindarks coming in to this transaction
