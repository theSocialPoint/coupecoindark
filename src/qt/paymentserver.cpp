...
const QString BITCOIN_IPC_PREFIX("coupecoindark:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click coupecoindark: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start coupecoindark: click-to-pay handler");
    else
...
{
    // clicking on coupecoindark: URLs creates FileOpen events on the Mac:
