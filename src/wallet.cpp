...
void CWalletTx::RelayWalletTransaction()
{
    ...
    {
        // Important: versions of coupecoindark before 0.8.6 had a bug that inserted
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            loop
            {
                ...
                if (nChange > 0)
                {
                    ...
                    // change transaction isn't always pay-to-coupecoindark-address
