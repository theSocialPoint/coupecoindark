...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless Coupecoindark

See readme-qt.rst for instructions on building Coupecoindark-Qt, the graphical user interface.
...
Notes
-----
The release is built with GCC and then "strip coupecoindarkd" to strip the debug
...
Security
--------
To help make your Coupecoindark installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Coupecoindark should be built with a non-executable stack
